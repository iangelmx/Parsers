...
union YYSTYPE
{
  ...
  /* FNCT  */
  symrec* FNCT;
#line 141 "mfcalc.tab.c" /* yacc.c:355  */
};
...
#line 158 "mfcalc.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "NUM", "VAR", "FNCT", "IF", "FINIF",
  "THEN", "'='", "'-'", "'+'", "'*'", "'/'", "NEG", "'^'", "'\\n'", "'('",
  "')'", "'{'", "'}'", "$accept", "input", "line", "selection_statement",
  "exp", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
      ...
      45,    43,    42,    47,   264,    94,    10,    40,    41,   123,
     125
};
# endif
...
{
      -3,   -12,    24,   -13,    27,   -13,    -1,   -13,     3,    16,
      27,   -13,    27,   -13,    62,    35,   -13,    27,    27,    20,
      44,    27,    27,    27,    27,    27,   -13,    17,    69,    53,
     -13,   -11,   -11,    20,    20,    20,    -3,   -13,     6,   -13
};
...
{
       2,     0,     0,     4,     0,     1,     0,     9,    10,     0,
       0,     5,     0,     3,     0,     0,     7,     0,     0,    17,
       0,     0,     0,     0,     0,     0,     6,     0,    11,     0,
      19,    14,    13,    15,    16,    18,     2,    12,     0,     8
};
...
{
      15,    23,    24,     1,    25,     4,    19,     6,    20,     7,
       8,     9,    17,    28,    29,    16,    10,    31,    32,    33,
      34,    35,    11,    12,     5,     6,    39,     7,     8,     9,
       7,     8,     9,    18,    10,    25,    36,    10,    38,     0,
      11,    12,     0,     0,    12,    21,    22,    23,    24,     0,
      25,     0,     0,    27,    21,    22,    23,    24,     0,    25,
       0,     0,    30,    21,    22,    23,    24,     0,    25,     0,
       0,    37,    21,    22,    23,    24,     0,    25,    26,    21,
      22,    23,    24,     0,    25
};

static const yytype_int8 yycheck[] =
{
       4,    12,    13,     6,    15,    17,    10,     1,    12,     3,
       4,     5,     9,    17,    18,    16,    10,    21,    22,    23,
      24,    25,    16,    17,     0,     1,    20,     3,     4,     5,
       3,     4,     5,    17,    10,    15,    19,    10,    36,    -1,
      16,    17,    -1,    -1,    17,    10,    11,    12,    13,    -1,
      15,    -1,    -1,    18,    10,    11,    12,    13,    -1,    15,
      -1,    -1,    18,    10,    11,    12,    13,    -1,    15,    -1,
      -1,    18,    10,    11,    12,    13,    -1,    15,    16,    10,
      11,    12,    13,    -1,    15
};
...
{
       0,     6,    22,    24,    17,     0,     1,     3,     4,     5,
      10,    16,    17,    23,    25,    25,    16,     9,    17,    25,
      25,    10,    11,    12,    13,    15,    16,    18,    25,    25,
      18,    25,    25,    25,    25,    25,    19,    18,    22,    20
};
